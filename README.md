...
A single-page design with Vite + React + TypeScript + Tailwind template with pre-configured ESLint (with Airbnb JS/React rules), Prettier and Git hooks powered by Husky out of the box 📦
